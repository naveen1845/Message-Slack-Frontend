...
import { ChannelPage } from '@/pages/Workspaces/ChannelPage';
...
export const AppRoutes = () => {
    return (
        <Routes>
            ...
            <Route path='/workspaces/:workspaceId/channels/:channelId' element={<ProtectedRouter><WorkspaceLayout><ChannelPage></ChannelPage></WorkspaceLayout></ProtectedRouter>} />
